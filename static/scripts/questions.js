...
function renderQuestion() {
  ...
  document.body.style.background = "url('/pictures/bg1.png') center center / cover no-repeat";

  // Display the header image
  const headerImage = document.createElement("img");
  headerImage.src = `/pictures/headerq${currentQuestionIndex + 1}.png`;
  ...
  textImage1.src = `/pictures/textq${currentQuestionIndex + 1}.png`;
  ...
  questionTextImage.src = `/pictures/textquestion${currentQuestionIndex + 1}.png`;
  ...
  dividerImage.src = `/pictures/dividershortened.png`;
  ...
  if (currentQuestionIndex < questions.length - 1) {
    nextButton.src = "/pictures/next.png";
    nextButton.onclick = () => {
      saveAnswer();
      currentQuestionIndex++;
      renderQuestion();
    ...
    nextButton.src = "/pictures/exit.png";
    nextButton.onclick = () => {
